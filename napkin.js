...
var napkin = (function() {
  ...
  var settings = {jitter: 1.5, marker_thickness: 1.3, colors: {"Black":"#000","Blue":"#1F75FE","Red":"#FF496C"}};
  ...
  //private functions
  var empty_svg = function(width = 1000, height = 700, color = "Blue", title = "A napkin SVG Illustration"){
  ...
  return {
    ...
    html_wrapper: function(width, height, color, title = "A napkin SVG Illustration"){
