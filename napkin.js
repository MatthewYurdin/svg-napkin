...
var napkin = (function() {
  ...
  //  -HAND contains instrunctions for drawing characters of text in my handwriting

  const SETTINGS = {JITTER: 1.5, MARKER_THICKNESS: 1.3, COLORS: {"Black":"#000","Blue":"#1F75FE","Red":"#FF496C","Background":"#fff"}};
